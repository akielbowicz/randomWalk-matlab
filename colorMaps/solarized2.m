function rgb=solarized2(m)
% solarized(m) returns an mx3 color map of even intensity.
% Implements a solarized color map by linear interpolation
% when m>=8, or matlab order when m<8; from the
% eight colors at http://ethanschoonover.com/solarized
% e.g. use set(0,'DefaultAxesColorOrder',0.9*solarized(7))
% AJ Roberts, 1 July 2013--Jan 2016
%{
$base03:    #002b36;
$base02:    #073642;
$base01:    #586e75;
...
if nargin==0, m=8; end
if m<8 % choose subset of colors, almost same order as matlab
    j=[2 4 7 3 8 5 1 6];
    j=sort(j(1:m));
    rgb=rgb(j(1:m),:);
